...
class BacktestingEngine:
    ...
    def load_data(self) -> None:
        ...
        while start < self.end:
            ...
            self.output(_("Loadintodegree：{} [{:.0%}]").format(progress_bar, progress))
        ...
        self.output(_("HistoricalDataLoadCompleted，Datavolume：{}").format(len(self.history_data)))
    ...
    def run_backtesting(self) -> None:
        ...
        for ix, i in enumerate(range(0, total_size, batch_size)):
            ...
            self.output(_("returnputintodegree：{} [{:.0%}]").format(progress_bar, progress))
    ...
    def calculate_result(self) -> DataFrame:
        ...
        if not self.trades:
            self.output(_("BacktestTradelogIs empty"))
    ...
    def calculate_statistics(
        ...
        if df is None:
            if self.daily_df.empty:
                self.output(_("BacktestresultIs empty，unableCalculateperformanceeffectstatisticsindicator"))
                return {}
        ...
        if output:
            ...
            self.output(_("max drawdowndaynumber: \t{}").format(max_drawdown_duration))
