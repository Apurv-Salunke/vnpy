...
class BaseDatafeed:
    ...
    def query_bar_history(self, req: HistoryRequest, output: Callable = print) -> list[BarData]:
        ...
        """
        output(_("Failed to query bar data: datafeed not configured correctly"))
        return []
    ...
    def query_tick_history(self, req: HistoryRequest, output: Callable = print) -> list[TickData]:
        ...
        """
        output(_("Failed to query tick data: datafeed not configured correctly"))
        return []
...
def get_datafeed() -> BaseDatafeed:
    ...
    if not datafeed_name:
        ...
        print(_("Datafeed not configured, please check global settings"))
    else:
