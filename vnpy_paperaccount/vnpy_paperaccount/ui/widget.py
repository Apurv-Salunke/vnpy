...
class PaperManager(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        """"""
        self.setWindowTitle("modelsimulateTrading")
        ...
        clear_button: QtWidgets.QPushButton = QtWidgets.QPushButton("clearNoneallPosition")
        ...
        form.addRow("market priceOrderandStopOrder Tradeslippage", slippage_spin)
        form.addRow("modelsimulateTradingPosition PnLCalculatefrequency", interval_spin)
        form.addRow("place orderafterimmediatelyuseCurrentorder bookmatch", instant_check)
