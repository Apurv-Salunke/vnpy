...
class RpcGateway(BaseGateway):
    """
    VeighNauseatConnectrpcServiceGateway。
    """

    default_name: str = "RPC"

    default_setting: dict[str, str] = {
        "activeRequest Address": "tcp://127.0.0.1:2014",
        "PushSubscribe Address": "tcp://127.0.0.1:4102"
    }
    ...
    def connect(self, setting: dict) -> None:
        ...
        req_address: str = setting["activeRequest Address"]
        pub_address: str = setting["PushSubscribe Address"]

        self.client.subscribe_topic("")
        self.client.start(req_address, pub_address)

        self.write_log("ServerConnectSuccess，StartInitializeQuery")
    ...
    def query_all(self) -> None:
        ...
        self.write_log("ContractInfoQuerySuccess")
        ...
        self.write_log("AccountInfoQuerySuccess")
        ...
        self.write_log("PositionInfoQuerySuccess")
        ...
        for order in orders:
            ...
            order.__post_init__()
            self.on_order(order)
        self.write_log("OrderInfoQuerySuccess")
        ...
        for trade in trades:
            ...
            trade.__post_init__()
            self.on_trade(trade)
        self.write_log("TradeInfoQuerySuccess")
